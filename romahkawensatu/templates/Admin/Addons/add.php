...
<div class="wrap" style="max-width:640px">
  ...
  <h1 class="h">New add-on</h1>
  <?= $this->Form->create($addon) ?>
  <div class="panel">
    <label>Add-on name</label><?= $this->Form->control('addon_name', ['label' => false, 'required' => true]) ?>
    <div class="row2">
      <div><label>Type</label><?= $this->Form->control('addon_type', ['label' => false, 'placeholder' => 'photography']) ?></div>
    ...
    <div class="row2">
      ...
      <div><label>Max per Booking</label><?= $this->Form->control('max_per_booking', ['type' => 'number', 'min' => 1, 'label' => false, 'value' => 1]) ?></div>
    </div>
    <div class="row2">
  ...
  <?= $this->Form->button('Save add-on', ['class' => 'btn']) ?>
