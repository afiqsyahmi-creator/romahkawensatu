...
<div class="wrap" style="max-width:560px">
  ...
  <h1 class="h">Edit studio</h1>

  <?php if ($studio->image): ?>
    <div style="margin-bottom:16px">
      <img src="/<?= h($studio->image) ?>" width="200" height="140" style="object-fit:cover;border-radius:3px;border:1px solid var(--line)" onerror="this.style.display='none'">
    </div>
  <?php endif; ?>
  ...
  <?= $this->Form->button('Update studio', ['class' => 'btn']) ?>
