...
<div class="wrap" style="max-width:560px">
  ...
  <h1 class="h">New Bundle Offer</h1>
  ...
  <div class="panel">
    ...
    <?= $this->Form->control('discount_amount', ['type' => 'number', 'step' => '0.01', 'label' => false, 'required' => true, 'placeholder' => 'e.g. 100']) ?>
    <label>Active</label>
    <?= $this->Form->checkbox('is_active', ['checked' => true, 'hiddenField' => false]) ?>
  </div>
  <?= $this->Form->button('Save bundle', ['class' => 'btn']) ?>
